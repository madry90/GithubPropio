...
public class SoundtracksActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Songs> soundtrackSongs =new ArrayList<Songs>();

        //Fill the array with songs
        soundtrackSongs.add(new Songs("Mirta da Silva","Tras Salomé"));
        soundtrackSongs.add(new Songs("Rich Mortimer", "Just For Now"));
        soundtrackSongs.add(new Songs("Celine Hayes","Waltz For Olivia"));
        soundtrackSongs.add(new Songs("Edgar De Vries","Sunset Aglow"));
        soundtrackSongs.add(new Songs("Alonzo Gautier","Soudainement"));
        soundtrackSongs.add(new Songs("Biba Dupont", "Mar De Ardora"));
        soundtrackSongs.add(new Songs("Maria Novotna", "Airborne"));
        ...
        SongAdapter adapter = new SongAdapter(this,soundtrackSongs);
